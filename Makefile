# This Makefile is for the Data extension to perl.
#
...
TO_INST_PM = Data/Walker.pm \
	Data/Wbackup.pm

PM_TO_BLIB = Data/Wbackup.pm \
	$(INST_LIBDIR)/Data/Wbackup.pm \
	Data/Walker.pm \
	$(INST_LIBDIR)/Data/Walker.pm
...
manifypods : pure_all Data/Wbackup.pm \
	Data/Walker.pm
	@$(POD2MAN) \
	Data/Wbackup.pm \
	$(INST_MAN3DIR)/Data::Wbackup.$(MAN3EXT) \
	Data/Walker.pm \
	$(INST_MAN3DIR)/Data::Walker.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/Data/Wbackup.pm $(INST_LIBDIR)/Data/Walker.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Walker\" VERSION=\"0,13,0,0\">\n}. qq{\t<TITLE>Walker</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Walker.ppd
